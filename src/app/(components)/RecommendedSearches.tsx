	...
	return (
		<>
			{lastSearches.length ? (
				<div className='mt-2 grid gap-2'>
					...
					{lastSearches
						...
						.map((stop, index) => (
							<Link
								className='group flex gap-3 rounded p-2 shadow bg-bg border-border border items-center'
			...
			<div className='mt-2 grid gap-2'>
				...
				>
					<svg xmlns='http://www.w3.org/2000/svg' height={20} width={20} viewBox='0 0 576 512' className='fill-textMuted'>
