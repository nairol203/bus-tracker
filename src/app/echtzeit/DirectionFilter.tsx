			...
			{({ open }) => (
				<div className='md:relative'>
					...
					>
						...
						<Listbox.Options className='z-20 absolute max-h-[26.5rem] inset-x-2 bottom-2 md:inset-auto md:mt-1 md:max-h-96 md:w-60 overflow-y-auto bg-secondary shadow-lg dark:bg-darkMode-secondary overscroll-contain pt-3 md:pt-0 rounded-2xl md:rounded'>
